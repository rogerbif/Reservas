...
class validacao {
	...
	function mensagens($num, $campo, $max, $min) {
		...
		$this->msg[1] = "CEP com formato invalido (Ex: XXXXX-XXX) <br />"; // CEP
		$this->msg[2] = "Data em formato invalido (Ex: DD/MM/AAAA) <br />"; // DATA
		$this->msg[3] = "Telefone invalido (Ex: 01433333333) <br />"; // TELEFONE
		$this->msg[4] = "CPF invalido (Ex: 11111111111) <br />"; // CPF
		$this->msg[5] = "IP invalido (Ex: 192.168.10.1) <br />"; // IP
		$this->msg[6] = "Preencha o campo ".$campo." com numeros <br />"; // APENAS NUMEROS
		$this->msg[7] = "URL especificada e invalida (Ex: http://www.google.com) <br />"; // URL
	...
	// Verificacao simples (Campo vazio, maximo/minimo de caracteres)
